...
import { FAB, ICON_BTN, TOP_ACTIONS } from './utils/twClasses.js'
...
const toastCls = [
  ...
  'opacity-0',
  'pointer-events-none',
  'shadow-[0_10px_28px_-8px_rgba(124,111,247,0.6),inset_0_1px_0_rgba(255,255,255,0.25)]',
  'transition-[opacity,transform]',
  'duration-300',
  '-translate-x-1/2',
  '-translate-y-[10px]',
].join(' ')
const toastOnCls = 'opacity-100 -translate-y-0!'
...
<template>
  ...
  <div :class="[toastCls, toastText ? toastOnCls : '']">{{ toastText }}</div>

  <div :class="TOP_ACTIONS" v-show="workout.view.value === 'timer' || workout.view.value === 'summary'">
    <button
      :class="ICON_BTN"
